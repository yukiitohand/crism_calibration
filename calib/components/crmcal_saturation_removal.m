function [DN14c,mask_saturation] = crmcal_saturation_removal(DN14b,VLdata,mask4095,varargin)
% [DN14c,mask_saturation] = crmcal_saturation_removal(DN14b,VLdata,mask4095,varargin)
