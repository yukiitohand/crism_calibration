function [ DN14b,sumGHOST_DN ] = remove_quadrantGhost( DN14a,GHdata,hkt,varargin )
...
rate = [hkt.data.RATE];
A = frame_rateTABformatter(rate,GHdata.tab,'IR_GHOST_A','BINX',binx);
B = frame_rateTABformatter(rate,GHdata.tab,'IR_GHOST_B','BINX',binx);
C = frame_rateTABformatter(rate,GHdata.tab,'IR_GHOST_C','BINX',binx);
D = frame_rateTABformatter(rate,GHdata.tab,'IR_GHOST_D','BINX',binx);
E = frame_rateTABformatter(rate,GHdata.tab,'IR_GHOST_E','BINX',binx);
