...
IR_14_BIT_LIMIT = rateQuadrantTABformatter(rate_id,VLdata.tab,'VNIR_14_BIT_LIMIT','BINX',binx);
IR_LINEARITY_LIMIT = rateQuadrantTABformatter(rate_id,VLdata.tab,'VNIR_LINEARITY_LIMIT','BINX',binx);
