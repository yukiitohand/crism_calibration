function [] = crism_calibration(obs_id,varargin)
...
if (rem(length(varargin),2)==1)
    ...
    for i=1:2:(length(varargin)-1)
        switch upper(varargin{i})
            ...
            case 'BKDATA1'
                BKdata1 = varargin{i+1};
            case 'BKDATA2'
                BKdata2 = varargin{i+1};
            case 'SAVE_PDIR'
...
switch lower(mode_calib)
    case 'yuki'
        [RDn,RDn_woc,RDn_bk1_o,RDn_bk2_o] = pipeline_calibration_IR_yuki(...
            ...
            'APBPRMVL',apbprmvl,'SAVE_MEMORY',save_mem,'DN4095_RMVL',0,...
            'BKGD_ROBUST',0);
    case 'yuki2'
        [RDn,RDn_woc,RDn_bk1_o,RDn_bk2_o] = pipeline_calibration_IR_yuki(...
            TRRIFdata,EDRdata,DFdata1,DFdata2,BKdata1,BKdata2,2,...
    ...
    case 'yuki3'
        ...
        [SPdata_o,RT14j_woc,RT14j,RT14h2_bk1_o,RT14h2_bk2_o]...
          = minipipeline_calibration_IR_SP_wCDRSP_yuki(...
            ...
            'BK_MEAN_ROBUST',1,'BK_MEAN_DN14',false,'MEAN_DN14',false);
        [RDn,RDn_woc,RDn_bk1_o,RDn_bk2_o] = pipeline_calibration_IR_yuki(...
            TRRIFdata,EDRdata,DFdata1,DFdata2,BKdata1,BKdata2,2,...
            'APBPRMVL',apbprmvl,'SAVE_MEMORY',save_mem,'DN4095_RMVL',1,...
            'BK_MEAN_ROBUST',1,'BK_MEAN_DN14',1,'SPdata_o',SPdata_o);
    case 'original'
